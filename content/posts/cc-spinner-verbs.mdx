...
Ghostty is GPU-accelerated and noticeably snappier than iTerm2 or Terminal.app, especially when Claude is streaming long outputs. Zellij lets me run multiple Claude instances side by side (different tasks, different repos) and serializes sessions to disk. I can close my laptop and pick up exactly where I left off.
