...
{{callout:info|It is also corollary to the halting problem — the problem of determining whether a given program will finish running or continue to run forever from an initial input.}}
